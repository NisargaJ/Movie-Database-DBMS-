...
<body class="mdc-typography">
  <div class="main">
    ...
    <h1 align="center" class="mdc-typography mdc-typography--headline2 headline">ADMIN</h1>
    <form style="text-align: center;" method="POST" action="enterAdmin.php">
        <br><input class="in" type="text" name="name" placeholder=" Admin Name" required><br>
